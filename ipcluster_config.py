...
#c.BaseParallelApplication.work_dir = u'/home/pedro.lisboa/.ipython/profile_default/security'
...
c.IPClusterStart.controller_ip = u'146.164.147.234'
...
#c.IPClusterStart.controller_launcer_class = 'SSHControllerLauncher'
#c.SSHControllerLauncher.hostname = 'pedro.lisboa@ferney.lps.ufrj.br'
#c.SSHControllerLauncher.user = os.environ.get('USER', 'username')
#c.SSHControllerLauncher.ip = '146.164.147.234'
...
#c.LocalControllerLauncher.controller_args = ["--ip=146.164.147.196"]
...
#c.SSHLauncher.hostname = 'ferney@lps.ufrj.br'

## user@hostname location for ssh in one setting
#c.SSHLauncher.location = 'pedro.lisboa@ferney.lps.ufrj.br'
...
## username for ssh
c.SSHLauncher.user = getpass.getuser()
...
#------------------------------------------------------------------------------
#### c.SSHEngineLauncher.engine_cmd = ['./ipengine']
#------------------------------------------------------------------------------
...
engine_cmd_path = os.path.join('/home', getpass.getuser(), 'ipengine')
c.SSHEngineSetLauncher.engines = {
        'ornex.lps.ufrj.br' : {'n':4,
                               'engine_cmd': [engine_cmd_path],
                              },

        'chamonix.lps.ufrj.br' : {'n':4,
                               'engine_cmd': [engine_cmd_path],
                              },

        'ferney.lps.ufrj.br'  : {'n':4,
                               'engine_cmd': [engine_cmd_path],
                              },
}
#c.SSHEngineSetLauncher.engine_cmd = ['/home/pedro.lisboa/ipengine']
#c.SSHEngineLauncher.engine_args = ['--location=146.164.147.234']
#------------------------------------------------------------------------------
